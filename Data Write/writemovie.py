...
collection = db["movie"]  # Replace with your collection name

# Read data from the DAT file and transform it into a list of dictionaries
data_to_insert = []
id = 1

with open("C:/Users/HP/Desktop/nirma/sem 7/BDA/innovative/ml-1m/ml-1m/moviess.dat", "r") as file:  # Replace with the path to your DAT file
    for line in file:
        ...
        if len(fields) >= 3:
            data_dict = {
                "_id": id,
                "MovieID": fields[0],  # Replace with actual field names and indices
                "MovieIDs": fields[1],
                "Genres": fields[2],
